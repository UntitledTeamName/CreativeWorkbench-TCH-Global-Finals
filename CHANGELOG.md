...
All notable changes to CharacterOS will be documented in this file.
...
- **WorkBuddy Skill Integration**: Created standalone `CharacterOS` Skill with conversational input collection, single-pass initial generation, and natural-language targeted editing.
